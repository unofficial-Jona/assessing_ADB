...
def train_one_epoch_unsupervised():
    BATCH_SIZE = 32
    log_file = 'unsupervised_tuning_log.txt'
    checkpoint_path = "unsupervised_backbone.pth"
    ...
    for idx, (images, _) in enumerate(pbar):
        ...
        if idx % log_interval == 0:
            ...
            with open(log_file, "a") as f:
                f.write(f"Epoch: {epoch + 1}, Batch: {idx + 1}, Loss: {loss:.4f}, Avg Loss: {avg_loss:.4f}\n")
            total_loss = 0
